...
class RegisterUser : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnRegistrar.setOnClickListener {
            val nombre = binding.txtNombreUser.text.toString()
                ...
                primerNombre.isNotBlank() && primerApellido.isNotBlank())
            {
                ...
                if (contrasena == repetirContrasena){
                    viewModel.registrar(nombre, correo, contrasena, dui, primerNombre, primerApellido, telefono.toInt(), rol)
            ...
            lifecycleScope.launch {
                if (result != null) {
                    ...
                    if (result.estado == "Exito"){
                        ...
                        DataStoreManager.saveUserType(requireContext(), "Comprador")
                        delay(1500)
